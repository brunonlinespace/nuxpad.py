...
class Nuxpad:
    def __init__(self, root):
        ...
        # Build Toolbar Components (File/Edit menus on left, format buttons in middle, theme toggle on right)
        self.create_toolbar()
    ...
    def create_toolbar(self):
        ...
        # Left Frame for Menus and Format buttons
        ...
        def create_menu_dropdown(parent, label):
            ...
            self.buttons.append(mb) # treat as button styling element
