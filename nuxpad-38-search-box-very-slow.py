...
#
# nuxpad.py
# Version: 38 (Search Box Very Slow)
# ==============================================================================
...
class Nuxpad:
    ...
    def create_toolbar(self):
        ...
        # Search Button comes after entry widget as requested ("search box to be on the right hand side, followed by the 'Search' button")
        self.search_btn = tk.Button(self.right_toolbar, text="Search", relief="flat", bd=0, padx=6, pady=2, cursor="hand2", command=self.find_text)
