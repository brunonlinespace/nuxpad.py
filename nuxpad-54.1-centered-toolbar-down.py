...
#
# nuxpad.py
# Version: 54.2 (=48.2 But Centered)
# ==============================================================================
...
class Nuxpad:
    def __init__(self, root):
        ...
        # Window Setup
        self.root.title("Untitled - Nuxpad v54.2")
    ...
    def create_toolbar(self):
        ...
        # Centered Frame for Menus & Toolbar Tools
        self.left_toolbar = tk.Frame(self.toolbar, bd=0, relief="flat")
        self.left_toolbar.pack(side="top", anchor="center")
