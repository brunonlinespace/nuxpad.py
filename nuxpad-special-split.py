...
#
# nuxpad.py
# Version: 55.1.3 (Configurable Top / Down Inversion Layout - No Separators / No Tick)
# ==============================================================================
...
class Nuxpad:
    def __init__(self, root):
        ...
        # Window Setup
        self.root.title("Untitled - Nuxpad v55.1.3")
    ...
    def create_toolbar(self, arrow_dir, arrow_char):
        ...
        toggles_menu.add_command(label="Top / Down Inversion", command=self.toggle_top_down_inversion)
    ...
    def toggle_top_down_inversion(self):
        self.top_down_inversion = not self.top_down_inversion
        self.save_preferences()
        self.setup_layout()
        self.apply_theme()
        self.update_line_numbers()
