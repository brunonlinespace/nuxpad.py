...
#
# nuxpad.py
# Version: 58.2 (In-line vs Split Search Toggle & Removed Menu Separators)
# ==============================================================================
...
class Nuxpad:
    def __init__(self, root):
        ...
        # Window Setup
        layout_version = "v53.2 (Split Search)" if self.split_search else "v48.3 (In-line Search)"
        self.root.title(f"Untitled - Nuxpad {layout_version}")
        ...
        # Bottom Search Bar Frame - Placed below the editor (only used in split search layout 53.2)
    ...
    def load_preferences(self):
        # Defaults (Default to layout 48.3 inline search per user instruction)
    ...
    def create_toolbar_inline(self):
        ...
        # Right Frame for Search Box Container (Layout 48.3 inline style)
    ...
    def toggle_split_search(self):
        ...
        # Rebuild layout dynamically without restarting application
        ...
        if self.split_search:
            ...
            self.create_toolbar_split()
            self.create_top_search()
            self.root.title("Untitled - Nuxpad v53.2 (Split Search)")
        else:
            self.top_search_frame.pack_forget()
            self.create_toolbar_inline()
            self.root.title("Untitled - Nuxpad v48.3 (In-line Search)")
    ...
    def update_title(self):
        ...
        layout_version = "v53.2" if self.split_search else "v48.3"
        self.root.title(f"{prefix}{display_name} - Nuxpad {layout_version}")
