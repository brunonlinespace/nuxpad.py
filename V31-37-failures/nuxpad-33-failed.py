...
class Nuxpad:
    ...
    def create_toolbar(self):
        ...
        # Right Frame for Character Counter, Separator, and Search
        ...
        theme_label = "☀️  Light Mode" if self.is_dark_mode else "🌙  Dark Mode"
        ...
        # --- Right Toolbar Components (Character Counter, Separator, Search) ---
    ...
    def apply_theme(self):
        ...
        # Update Toggles menu item text dynamically using positional index arguments correctly
        if hasattr(self, 'toggles_menu_ref'):
            self.toggles_menu_ref.entryconfigure(2, label=new_theme_label)
