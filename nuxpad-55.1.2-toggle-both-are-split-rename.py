...
#
# nuxpad.py
# Version: 55.2 (Configurable Top / Down Split Layout)
# ==============================================================================
...
class Nuxpad:
    def __init__(self, root):
        ...
        # Window Setup
        self.root.title("Untitled - Nuxpad v55.2")
    ...
    def load_preferences(self):
        ...
        self.top_down_split = False  # False = Top toolbar / Bottom search, True = Bottom toolbar / Top search[cite: 7]
        self.word_wrap = True
        ...
        try:
            if os.path.exists(self.config_file):
                with open(self.config_file, "r", encoding="utf-8") as f:
                    ...
                    self.top_down_split = data.get("top_down_split", False)
    ...
    def save_preferences(self):
        try:
            data = {
                ...
                "top_down_split": self.top_down_split,
    ...
    def create_toolbar(self, arrow_dir, arrow_char):
        ...
        self.split_var = tk.BooleanVar(value=self.top_down_split)
        ...
        toggles_menu.add_checkbutton(label="Top / Down Split", variable=self.split_var, command=self.toggle_top_down_split)
    ...
    def toggle_top_down_split(self):
        self.top_down_split = self.split_var.get()
        self.save_preferences()
        self.setup_layout()
        self.apply_theme()
        self.update_line_numbers()
