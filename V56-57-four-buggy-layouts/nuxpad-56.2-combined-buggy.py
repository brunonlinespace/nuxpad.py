...
#
# nuxpad.py
# Version: 57.1 (Debugged Theming Controller)
# ==============================================================================
...
class Nuxpad:
    def __init__(self, root):
        ...
        # Window Setup
        self.root.title("Untitled - Nuxpad v57.1")
    ...
    def create_toolbar(self, arrow_dir, arrow_char, inline_search):
        ...
        # Submenu for layout modes
        layout_menu = tk.Menu(toggles_menu, tearoff=0)
        toggles_menu.add_cascade(label="Layout Mode", menu=layout_menu)
        self.menus.append(layout_menu) # Track nested submenus for global theme propagation
    ...
    def apply_theme(self):
        if self.is_dark_mode:
            ...
            btn_bg, btn_fg, btn_active_bg, btn_active_fg = "#1e1e1e", "#d4d4d4", "#333333", "#ffffff"
            ...
            btn_bg, btn_fg, btn_active_bg, btn_active_fg = "#ffffff", "#000000", "#e8e8e8", "#000000"
        ...
        for btn in self.buttons:
            try:
                btn.config(bg=btn_bg, fg=btn_fg, activebackground=btn_active_bg, activeforeground=btn_active_fg)
            except tk.TclError:
                pass # Handles specialized Label status widgets safely
