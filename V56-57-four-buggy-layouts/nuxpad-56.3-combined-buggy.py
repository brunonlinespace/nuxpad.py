...
#
# nuxpad.py
# Version: 57.2 (Split Layout Theming Fixes)
# ==============================================================================
...
class Nuxpad:
    def __init__(self, root):
        ...
        # Window Setup
        self.root.title("Untitled - Nuxpad v57.2")
    ...
    def apply_theme(self):
        ...
        self.search_frame.config(bg=bg_color) # Fixes split Options 3 and 4 background mismatch
