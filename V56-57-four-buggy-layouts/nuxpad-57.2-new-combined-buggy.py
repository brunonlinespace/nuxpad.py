...
#
# nuxpad.py
# Version: 57 (Unified Multi-Layout Edition)
# ==============================================================================
...
class Nuxpad:
    def __init__(self, root):
        ...
        # Window Setup
        self.root.title("Untitled - Nuxpad v57")
    ...
    def build_layout_structure(self):
        ...
        # Layout 1: In-line Top (Nuxpad-53.2)
        # Layout 2: In-line Down (Nuxpad-53.1)
        # Layout 3: Split Toolbar Top, Search Down (Nuxpad-48.3)
        # Layout 4: Split Toolbar Down, Search Top (Nuxpad-48.2)
    ...
    def create_components(self):
        ...
        # --- Toggles Menu with Sub-menu for Layouts ---
    ...
    def change_layout(self):
        ...
        # Re-initialize structure and components
        self.build_layout_structure()
        self.create_components()
        ...
        # Explicitly enforce visibility state from user preference
        if self.show_counters:
            self.status_label.pack(side="left", padx=2, pady=2)
        else:
