...
#
# nuxpad.py
# Version: 55.2.3 (Responsive In-line Search & Separator-Free Menus)
# ==============================================================================
...
class Nuxpad:
    def __init__(self, root):
        ...
        # Window Setup
        self.root.title("Untitled - Nuxpad v55.2.3")
        ...
        try:
            if os.path.exists(self.config_file):
                with open(self.config_file, "r", encoding="utf-8") as f:
                    ...
                    self.top_toolbar = data.get("top_toolbar", True)
    ...
    def create_toolbar(self):
        ...
        # Right Frame for Search Box Container (Responsive expansion)[cite: 3]
        ...
        def create_menu_style_button(parent, text):
            mb = tk.Menubutton(parent, text=text, relief="flat", bd=0, padx=6, pady=2, cursor="hand2")
        ...
        self.file_mb, file_menu = create_menu_style_button(self.left_toolbar, "File")
        ...
        self.edit_mb, edit_menu = create_menu_style_button(self.left_toolbar, "Edit")
        ...
        self.toggles_mb, toggles_menu = create_menu_style_button(self.left_toolbar, "Toggles")
        ...
        toggles_menu.add_command(label="Top / Down Inversion", command=self.toggle_layout)
        ...
        # --- Browser-Style Integrated Search Box & Search Action Icon/Button Container (Responsive fill) ---[cite: 3]
    ...
    def apply_layout(self):
        """Updates toolbar positioning, menu direction, and menu arrow indicators dynamically."""
        ...
        self.file_mb.config(text=f"File {arrow}", direction=direction)
        self.edit_mb.config(text=f"Edit {arrow}", direction=direction)
        self.toggles_mb.config(text=f"Toggles {arrow}", direction=direction)

    def toggle_layout(self):
        self.top_toolbar = not self.top_toolbar
