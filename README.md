...
- v58.1: Successful attempt to toggle layout change between 53.2 (in-line top) and v48.3 (toolbar top / search down)
- v57s: Second buggy attempt to toggle 4 layout changes by mega merging 53.2 (in-line top), v53.1 (in-line down), v48.3 (toolbar top / search down), and v48.1 (toolbar down / search top).
...
- v53.2: Toolbar with in-line Search Box now moved to top of text area. <b>This is second base layout for v58.</b>
...
- v50.1-50.3: Buggy attempts to toggle layout swap between Split Search Box and Toolbar positions: Top Search, Bottom Toolbar vs Bottom Search, Top Toolbar. 
