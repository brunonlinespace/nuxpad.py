...
#
# nuxpad.py
# Version: 55.1 (Configurable Top / Down Inversion Layout)
# ==============================================================================
...
class Nuxpad:
    def __init__(self, root):
        ...
        # Window Setup
        self.root.title("Untitled - Nuxpad v55.1")
    ...
    def load_preferences(self):
        ...
        self.top_down_inversion = False  # False = Top toolbar / Bottom search, True = Bottom toolbar / Top search
        self.word_wrap = True
        ...
        try:
            if os.path.exists(self.config_file):
                with open(self.config_file, "r", encoding="utf-8") as f:
                    ...
                    self.top_down_inversion = data.get("top_down_inversion", False)
    ...
    def save_preferences(self):
        try:
            data = {
                ...
                "top_down_inversion": self.top_down_inversion,
    ...
    def setup_layout(self):
        ...
        # Clear toolbar contents to rebuild with correct menu arrow direction
        for widget in self.toolbar.winfo_children():
            widget.destroy()
        for widget in self.search_frame.winfo_children():
            widget.destroy()

        if not self.top_down_inversion:
            # Layout A: Top Toolbar, Middle Editor, Bottom Search Bar (Downward Arrows)
            ...
            # Layout B: Top Search Bar, Middle Editor, Bottom Toolbar (Upward Arrows)
        ...
        self.create_toolbar(arrow_dir, arrow_char)
    ...
    def create_toolbar(self, arrow_dir, arrow_char):
        self.buttons = []
        self.menus = []
        self.separators = []
        ...
        # --- File Menu ---
        file_menu = create_menu_style_button(self.left_toolbar, f"File {arrow_char}")
        ...
        # --- Edit Menu ---
        edit_menu = create_menu_style_button(self.left_toolbar, f"Edit {arrow_char}")
        ...
        # --- Toggles Menu ---
        toggles_menu = create_menu_style_button(self.left_toolbar, f"Toggles {arrow_char}")
        ...
        self.inversion_var = tk.BooleanVar(value=self.top_down_inversion)
        ...
        toggles_menu.add_checkbutton(label="Top / Down Inversion", variable=self.inversion_var, command=self.toggle_top_down_inversion)
    ...
    def toggle_top_down_inversion(self):
        self.top_down_inversion = self.inversion_var.get()
        self.save_preferences()
        self.setup_layout()
        self.apply_theme()
        self.update_line_numbers()
