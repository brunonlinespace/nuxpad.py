...
#
# nuxpad.py
# Version: 28 (Formatting Buttons Cleaned)
# ==============================================================================
...
class Nuxpad:
    ...
    def create_toolbar(self):
        ...
        def create_menu_style_button(parent, text):
            # direction="above" forces dropdowns to open upwards so they don't get hidden by the bottom taskbar
        ...
        # --- Left Format Buttons ---
        create_action_menubutton(self.left_toolbar, "Bold", lambda: self.toggle_tag("bold"))
        create_action_menubutton(self.left_toolbar, "Italic", lambda: self.toggle_tag("italic"))
        create_action_menubutton(self.left_toolbar, "Underline", lambda: self.toggle_tag("underline"))
