...
#
# nuxpad.py
# Version: 49.2 (Toggleable In-line Search Bar - Launch Failure)
# ==============================================================================
...
class Nuxpad:
    def __init__(self, root):
        ...
        # Window Setup
        self.root.title("Untitled - Nuxpad v49.2")
        ...
        # Top Search Bar Frame - Placed above the editor (Conditional visibility)
        self.top_search_frame = tk.Frame(self.root, bd=0, relief="flat")
        if not self.inline_toolbar:
        ...
        # Build Toolbar & Search Components based on layout preference
        self.create_toolbar()
        ...
        try:
            if os.path.exists(self.config_file):
                with open(self.config_file, "r", encoding="utf-8") as f:
                    ...
                    self.inline_toolbar = data.get("inline_toolbar", False)
    ...
    def create_toolbar(self):
        ...
        # Right Frame for In-line Toolbar Search Box (if enabled)
        ...
        self.inline_var = tk.BooleanVar(value=self.inline_toolbar)
        ...
        toggles_menu.add_checkbutton(label="In-line Toolbar", variable=self.inline_var, command=self.toggle_inline_toolbar)
        ...
        # Build Search Bar based on layout choice
        if self.inline_toolbar:
            ...
            self.search_widgets.append(self.inline_search_btn)
        else:
    ...
    def toggle_inline_toolbar(self):
        self.inline_toolbar = self.inline_var.get()
        if self.inline_toolbar:
            self.top_search_frame.pack_forget()
        else:
            self.top_search_frame.pack(side="top", fill="x", padx=5, pady=(5, 0), before=self.editor_frame)
        self.create_toolbar()
        self.apply_theme()
        self.save_preferences()
    ...
    def apply_theme(self):
        ...
        for widget in self.search_widgets:
            widget.config(bg=entry_bg, fg=entry_fg, insertbackground=insert_color, activebackground=entry_bg, activeforeground=entry_fg)
