...
#
# nuxpad.py
# Version: 50.3 (Buggy Top / Down Mode Toggle for Toolbar and Search Positions)
# ==============================================================================
...
class Nuxpad:
    def __init__(self, root):
        ...
        # Window Setup
        self.root.title("Untitled - Nuxpad v50.3")
        ...
        # Toolbar Frame - bezel-less
        self.toolbar = tk.Frame(self.root, bd=0, relief="flat")
        
        # Search Bar Frame - Placed relative to configuration layout
        self.top_search_frame = tk.Frame(self.root, bd=0, relief="flat")

        # Apply initial layout positions based on preferences
    ...
    def apply_layout_positions(self):
        # Clear existing pack positions to allow swapping
        self.toolbar.pack_forget()
        self.top_search_frame.pack_forget()

        if self.inline_toolbar:
            # In-line Configuration: Toolbar on top of text area, Search bar on bottom of text area
            self.toolbar.pack(side="top", fill="x", padx=5, pady=(5, 0))
            self.top_search_frame.pack(side="bottom", fill="x", padx=5, pady=5)
        else:
            # Split Configuration: Search bar on top of text area, Toolbar on bottom of text area
