...
#
# nuxpad.py
# Version: 49.3 (Toggleable In-line Search Bar - Launch Failure)
# ==============================================================================
...
class Nuxpad:
    def __init__(self, root):
        ...
        # Window Setup
        self.root.title("Untitled - Nuxpad v49.3")
    ...
    def apply_theme(self):
        ...
        for widget in self.search_widgets:
            widget.config(bg=entry_bg, fg=entry_fg, insertbackground=insert_color)
