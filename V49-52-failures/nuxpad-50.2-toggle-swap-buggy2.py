...
#
# nuxpad.py
# Version: 50.2 (Buggy Top / Down Mode Toggle for Toolbar and Search Positions)
# ==============================================================================
...
class Nuxpad:
    def __init__(self, root):
        ...
        # Window Setup
        self.root.title("Untitled - Nuxpad v50.2")
        ...
        # Search Bar Frame - Placed relative to editor
    ...
    def apply_layout_positions(self):
        ...
        if self.top_down_mode:
            # Top / Down Mode: Toolbar on top of text area, Search bar on bottom of text area
            self.toolbar.pack(side="top", fill="x", padx=5, pady=(5, 0))
            self.top_search_frame.pack(side="bottom", fill="x", padx=5, pady=5)
        else:
            # Default Mode: Search bar on top of text area, Toolbar on bottom of text area
