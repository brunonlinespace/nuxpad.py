...
class Nuxpad:
    ...
    def update_line_numbers(self, event=None):
        ...
        # Use a single consistent background and matching muted foreground
    ...
    def apply_theme(self):
        ...
        # Unified background across root, editor components, and toolbars
