...
class Nuxpad:
    ...
    def create_toolbar(self):
        ...
        # --- Separator Frame ---
        sep1 = tk.Frame(self.left_toolbar, width=2, bd=0, relief="sunken")
        sep1.pack(side="left", fill="y", padx=6, pady=4)
        self.separators.append(sep1)
        ...
        self.status_label = tk.Label(self.left_toolbar, text="Lines: 1 | Chars: 0", relief="flat", bd=0, padx=6, pady=2, font=self.normal_font)
        self.status_label.pack(side="left", padx=2, pady=2)
        self.status_labels.append(self.status_label)
        ...
        self.search_entry = tk.Entry(self.search_container, textvariable=self.search_var, relief="flat", bd=0, width=18, font=self.normal_font, highlightthickness=0)
    ...
    def apply_theme(self):
        ...
        for status in self.status_labels:
            status.config(bg=bg_color, fg=fg_color)
