...
class LinuxWordPad:
    def __init__(self, root):
        ...
        # Toolbar Frame (Container for buttons) - Placed at the BOTTOM
    ...
    def create_toolbar_buttons(self):
        ...
        # Inner frame packed inside the bottom toolbar to easily center all buttons together
        self.button_inner_frame = tk.Frame(self.toolbar)
        self.button_inner_frame.pack(anchor="center", pady=2)

        def add_btn(text, command, padx=5):
            btn = tk.Button(self.button_inner_frame, text=text, command=command, relief="groove", bd=1, padx=padx)
    ...
    def insert_bullet_point(self):
        # Insert bullet point directly at the current cursor line without extra leading newline padding
    ...
    def apply_theme(self):
        ...
        # Configure window, toolbar containers, and inner frame background
