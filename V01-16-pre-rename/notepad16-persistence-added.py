...
class LinuxWordPad:
    def __init__(self, root):
        ...
        # Configuration file path for persistence (saves in user's home directory)
        self.config_file = os.path.expanduser("~/.linux_wordpad_config.json")
    ...
    def create_toolbar_buttons(self):
        ...
        self.theme_btn = add_btn("☀️" if self.is_dark_mode else "🌙", self.toggle_theme, padx=8)
